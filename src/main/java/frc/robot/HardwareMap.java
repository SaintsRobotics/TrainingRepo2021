...
public class HardwareMap {
        public class SwerveDrivetrainHardware {
                public SwerveModule frontLeft = new SwerveModule(swerveModuleHardware,
                                ...
                                Constants.SwerveConstants.WHEEL_BASE / 2, Constants.SwerveConstants.TRACK_WIDTH / 2, swerveModuleHardware.frontLeftAbsoluteEncoder);
                public SwerveModule frontRight = new SwerveModule(swerveModuleHardware,
                                ...
                                Constants.SwerveConstants.WHEEL_BASE / 2, -Constants.SwerveConstants.TRACK_WIDTH / 2, swerveModuleHardware.frontRightAbsoluteEncoder);
                public SwerveModule rearLeft = new SwerveModule(swerveModuleHardware,
                                ...
                                -Constants.SwerveConstants.WHEEL_BASE / 2, Constants.SwerveConstants.TRACK_WIDTH / 2, swerveModuleHardware.rearLeftAbsoluteEncoder);
                public SwerveModule rearRight = new SwerveModule(swerveModuleHardware,
                                ...
                                -Constants.SwerveConstants.WHEEL_BASE / 2, -Constants.SwerveConstants.TRACK_WIDTH / 2, swerveModuleHardware.rearRightAbsoluteEncoder);
        }
        ...
        public class SwerveModuleHardware {
                ...
                public AbsoluteEncoder frontLeftAbsoluteEncoder = new AbsoluteEncoder(
                                Constants.SwerveConstants.AbsoluteEncoderConstants.frontLeftEncoder, Constants.SwerveConstants.AbsoluteEncoderConstants.frontLeftOffset);
                ...
                public AbsoluteEncoder frontRightAbsoluteEncoder = new AbsoluteEncoder(
                                Constants.SwerveConstants.AbsoluteEncoderConstants.frontRightEncoder, Constants.SwerveConstants.AbsoluteEncoderConstants.frontRightOffset);
                ...
                public AbsoluteEncoder rearLeftAbsoluteEncoder = new AbsoluteEncoder(
                                Constants.SwerveConstants.AbsoluteEncoderConstants.rearLeftEncoder, Constants.SwerveConstants.AbsoluteEncoderConstants.rearLeftOffset);
                ...
                public AbsoluteEncoder rearRightAbsoluteEncoder = new AbsoluteEncoder(
                                Constants.SwerveConstants.AbsoluteEncoderConstants.rearRightEncoder, Constants.SwerveConstants.AbsoluteEncoderConstants.rearRightOffset);
        }
